...
public class RadioButtonTest extends BaseTest {
    ...
    public void selectMaleAge_18_25() throws IOException {
        ...
        Assert.assertTrue(radioButtonPage.isParticulerAgeSelected1825(), "❌ Age 18-25 radio button should be selected!");
    ...
    public void selectFemaleOption() throws IOException {
        ...
        Assert.assertTrue(radioButtonPage.isParticulerAgeSelected2635(), "❌ Age 26-35 radio button should be selected!");

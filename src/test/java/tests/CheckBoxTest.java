...
public class CheckBoxTest extends BaseTest {
	...
	private final By[] checkBoxes = { By.xpath("//*[@value='Reading']"), By.xpath("//*[@value='Traveling']"),
			By.xpath("//*[@value='Gaming']"), By.xpath("//*[@value='Cooking']"), By.xpath("//*[@value='Newsletter']"),
			By.xpath("//*[@value='Promotions']") };

	/**
	 * ✅ Runs once before all tests in this class. Initializes driver and performs
	 * login only once.
	 */
	...
	public void testNavigateToCheckBoxMenu() {
		...
		Assert.assertTrue(driver.findElement(By.xpath("//*[@value='Reading']")).isDisplayed(),
	...
	public void testSelectIndividualCheckBox() {
		...
		Assert.assertTrue(checkBoxPage.isCheckBoxSelected(readingCheckBox), "❌ Reading checkbox should be selected!");
	...
	public void testDeselectIndividualCheckBox() {
		...
		Assert.assertFalse(checkBoxPage.isCheckBoxSelected(readingCheckBox),
